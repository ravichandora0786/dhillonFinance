...
import { createParent, setParentPagination, updateParent } from "../slice";
import { toast } from "react-toastify";
import CustomCheckbox from "@/components/ui/customCheckBox";
import { useRouter } from "next/navigation";

export default function AddEditParent() {
                ...
                dispatch(
                  createParent({
                    ...
                    onSuccess: (response) => {
                      ...
                      dispatch(
                        setParentPagination({ pageIndex: 0, pageSize: 10 })
                      );
                      handleCancel();
                    },
                    onFailure: (error) => {
